    ...
    return (
        ...
        <form className={classes.container} noValidate autoComplete="off">
            ...
            <Grid container justify="center">
                ...
                <TextField id="name" label="Application Number"  name="applicationNumber"
                    className={classes.textField} value={applicationNumber}
            ...
            <Grid container justify="center">
                ...
                <TextField id="name" label="Mobile Number"  name="mobileNumber"
                    className={classes.textField} value={mobileNumber}
                    InputProps={{ classes: { input: classes.textField, }, }}
                    InputLabelProps={{ classes: { root: classes.textField, } }}
                    FormHelperTextProps={{ classes: { root: classes.textField, } }}
        ...
        <form className={classes.container} noValidate autoComplete="off">
            <div style={{ width: '100%' }}>
                <Box component="span" visibility={student.length === 0 ? "hidden" : "visible"}>
